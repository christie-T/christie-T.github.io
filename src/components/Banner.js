        ...
        <Row className="aligh-items-center">
          <Col xs={12} md={6} xl={7}>
            <div className="headertxt">
              ...
              <h1>
                hello, i'm <span className="christie">christie</span>.
              </h1>
              ...
              <p2>
                {" "}
                I'm a third-year Computer Science student @ YU from Toronto,
                Canada. Below is my project archive and a little about me.{" "}
              </p2>

              <button
                onClick={() =>
                  (window.location.href = "mailto:christietang23@gmail.com")
                }
                onMouseEnter={() => setIsHovered(true)}
                onMouseLeave={() => setIsHovered(false)}
              >
                contact me!{" "}
                {isHovered ? <MailboxFlag size={25} /> : <Mailbox size={25} />}
              </button>
            </div>
          </Col>
